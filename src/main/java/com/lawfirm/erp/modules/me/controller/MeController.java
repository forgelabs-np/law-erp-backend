...
public class MeController {
    ...
    @Operation(summary = MeConstants.CHANGE_PASSWORD_SUMMARY,
            description = MeConstants.CHANGE_PASSWORD_DESCRIPTION)
    public ResponseEntity<ApiResponse<Void>> changeOwnPassword(
            @Valid @RequestBody ApiRequest<ChangeOwnPasswordRequest> request) {
        meService.changeOwnPassword(request.getData());
        return responseHandler.ok(null, "Password changed. Other sessions have been signed out.");
    }
}
